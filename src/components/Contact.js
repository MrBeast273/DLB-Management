...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setSubmitted(true);
    // Yahan backend ya email service ka logic lagaya ja sakta hai
  };
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:03055555555" style={{ fontSize: '1.2rem', fontWeight: 800, color: '#FFFFFF', textDecoration: 'none' }}>
                    0305-5555555
                  </a>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#FFFFFF' }}>info@dlbmanagement.com</div>
                </div>
              </div>
